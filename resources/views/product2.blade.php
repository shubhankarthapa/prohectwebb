 ...
 @endif
    ...
    <div class="container">
      ...
      <div class="info_contact">
        <div class="row">
          ...
          <div class="col-md-4">
            <a href="mailto:shubhankar@myktm.ml">
  ...
  <section class="container-fluid footer_section ">
    <p>
      ...
      <a href="https://www.snype.tk/">Shubhankar</a><a style="float: right" href="#top"><button style="border: 0px;background:none;">Go To Top</button></a>
    </p>
  </section>
  <!-- footer section -->
